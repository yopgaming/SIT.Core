...
namespace SIT.Core.Core
{
    public abstract class ASITGame : BaseLocalGame<GamePlayerOwner>, IBotGame
    {
            ...
            , TimeSpan sessionTime) where T : ASITGame
        {
             ...
             var r = BaseLocalGame<GamePlayerOwner>
            ...
            r.func_1 = (EFT.Player player) => GamePlayerOwner.Create<GamePlayerOwner>(player, inputTree, insurance, backEndSession, commonUI, preloaderUI, gameUI, r.GameDateTime, location);
