...
5. **Set up your firewall**: open (or _allow_) ports `6969` and `6970` in Windows firewall settings (or whatever firewall you use). This step will ensure that your computer will accept traffic on those ports.
