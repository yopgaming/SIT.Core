...
namespace DrakiaXYZ.Waypoints
{
    public class CustomWaypointLoader
    {
        ...
        public void loadData()
        {
            ...
            // TODO: Paulov - Check embedded files
            ...
            //            continue;
            //        }
            //        PatchConstants.Logger.LogInfo(name);
            //        var path = name.Replace(".json", "");
            //        using (Stream input = assembly.GetManifestResourceStream(name))
            //        {
            //            Directory.CreateDirectory(Path.Combine(WaypointsPlugin.CustomFolder, path));
            //            using (Stream output = File.Create(Path.Combine(WaypointsPlugin.CustomFolder, name)))
            //            {
            //                input.CopyTo(output);
            //            }
            //        }
