...
//{
//    public class Player_Tilt_Patch : ModuleReplicationPatch
//    {
//        private static Dictionary<string, float> LastSpeedDelta = new();
//        private static List<long> ProcessedCalls = new();
//        public static Dictionary<string, bool> CallLocally = new();
//        public override Type InstanceType => typeof(EFT.MovementState);
//        public override string MethodName => "SetTilt";
