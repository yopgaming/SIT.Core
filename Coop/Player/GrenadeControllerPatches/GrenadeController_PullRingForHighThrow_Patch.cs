...
namespace SIT.Core.Coop.Player.GrenadeControllerPatches
{
    internal class GrenadeController_PullRingForHighThrow_Patch : ModuleReplicationPatch
    {
        ...
        public GrenadeController_PullRingForHighThrow_Patch()
        {
        }

        public GrenadeController_PullRingForHighThrow_Patch(Type type)
        {
        ...
        public override void Replicated(EFT.Player player, Dictionary<string, object> dict)
        {
            ...
            //Logger.LogDebug("GrenadeController_PullRingForHighThrow_Patch:Replicated");
